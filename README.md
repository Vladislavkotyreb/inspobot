...
100 тестов: профиль и ротация тем, сборка запроса под каждый инструмент Mobbin,
...
| `INSPOBOT_IMAGE_MODE` | `photo` | `document` — без сжатия Telegram, мелкий текст читается |
